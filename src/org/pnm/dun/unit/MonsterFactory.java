...
public class MonsterFactory {
	...
	public static Unit generic(int def, int arm, int mat, int pow) {
		Unit unit = new Monster("Grunt", "T_U_KrielWarrior", 7, 4, def, arm, 4);
		unit.addWep(new Weapon("Club",pow,mat));
		return unit;
	}
